...
function TalentDashboard() {
  ...
  return (
    <>
      ...
      {/* Recent applications + Profile completion panel — items-start fixes the empty-state gap */}
      ...
      {/* Recommended for you + Latest updates */}
      <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-3">
        {/* Recommended for you */}
        <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4 transition-shadow duration-200 hover:shadow-md sm:p-6 lg:col-span-2">
          <div className="mb-4 flex items-center justify-between">
