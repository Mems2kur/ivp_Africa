...
const BrowseCategories: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 pt-28 pb-20">
      ...
      <div className="section-container px-20 py-20 mt-16">
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Popular Categories</h2>
            <p className="text-gray-500 mt-1">Select a category to view available roles</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {CATEGORIES.map((category) => (
            <Link 
              ...
              className="bg-white p-6 rounded-2xl shadow-sm border-none border-gray-100 hover:shadow-xl hover:-translate-y-1 hover:border-primary/30 transition-all duration-300 group block relative overflow-hidden"
            >
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="w-14 h-14 bg-primary/10 text-primary rounded-xl flex items-center justify-center group-hover:bg-[#8c52ff] group-hover:text-white transition-colors duration-300">
                  {category.icon}
                </div>
                <span className="bg-gray-50 text-gray-600 text-xs font-bold px-3 py-1.5 rounded-full border border-gray-100">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {category.popularRoles.map((role, idx) => (
                  <span key={idx} className="text-[11px] font-semibold text-gray-500 bg-gray-50 px-2.5 py-1 rounded-md border border-gray-100">
                    {role}
                  </span>
                ))}
              </div>
      ...
      <div className="section-container mt-24">
        <div className="bg-gray-900 rounded-3xl p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 flex-shrink-0 w-full md:w-auto">
            <Button 
              ...
              variant="primary"
              size="md"
              className="bg-primary text-white w-full md:w-auto px-8 py-4 rounded-xl md:rounded-full font-bold shadow-lg transition-all duration-300 text-center flex justify-center"
            >
              Search All Jobs
            </Button>
          </div>
